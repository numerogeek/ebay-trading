...
class FeatureIDCodeType extends EbatNs_EnumType
{
     ...
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site requires a prospective bidder of an auction item
     * to read and agree to the terms in eBay's privacy policy before bidding on the item.
     **/
     ...
     * and
     * Category.SafePaymentRequired
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site, and individual categories on that site, require
     * that the seller set at least one accepted payment method in the listing that is certified by eBay to be a "safe
     * payment method".
     **/
     ...
     * <span class="tablenote">
     * Note:
     * This value is deprecated since it is only applicable to the eBay India site, and this marketplace is no
     ...
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site and individual categories on that site support
     * Paisa Pay Full Escrow as an accepted payment method. This field is only relevant to listings on the eBay India
     * site, which is the only site where Paisa Pay is available.
     **/
     ...
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site and individual categories are enabled with PayPal
     * Purchase Protection. Of course, an eligible item must be purchased with PayPal to be eligible for PayPal Purchase
     * Protection.
     **/
     ...
     * and
     * Category.BuyerGuaranteeEnabled
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site and individual categories are enabled with the
     * Australian version of the Buyer Protection program. This enumeration value is only applicable to the eBay
     * Australia site.
     **/
     ...
     * fields in the
     * GetCategoryFeatures
     * response will indicate the escrow workflows that will be used for individual categories on the eBay India site.
     * This enumeration value is only applicable to the eBay India site, and only if Paisa Pay Full Escrow is an
     ...
     * and
     * Category.PayPalRequired
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site and individual categories require PayPal as one of
     * the accepted payment methods in a listing. This value is not applicable in countries where PayPal is not
     * available.
     **/
     ...
     * boolean field in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site supports Motors National listings for sellers with
     * a specialty dealer subscription for selling motor vehicles.
     **/
    ...
    /**
     * If this value is specified, the
     * SiteDefaults.NonSubscription
     * boolean field in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site supports Motors National listings for sellers
     * without a dealer subscription for selling motor vehicles.
     **/
    const CodeType_NonSubscription = 'NonSubscription';

    /**
     * If this value is specified, the
     * SiteDefaults.IntangibleEnabled
     * and
     * Category.IntangibleEnabled
     * boolean fields in the
     * GetCategoryFeatures
     * response will indicate whether or not the specified eBay site and individual categories allow sellers to sell
     * intangible items.
     **/
    ...
    /**
     * This enumeration value is no longer applicable. Use the <code>ProductRequiredEnabled</code> enumeration value
     * instead to see if a category supports listings that are associated with an eBay Catalog product.
     **/
    ...
    /**
     * This value is used to see if the site supports Product-Based Shopping Experience listings (listings associated
     * with an eBay catalog product).
     * 
     * The
     * Category.ProductRequiredEnabled
     * field will only be returned if the category requires association with an eBay Catalog product.
     * 
     * <span class="tablenote">
     * Note:
     * Due to the rollback of the Product-Based Shopping Experience mandate for all eBay categories, the value for
     * this field should never get returned as <code>Enabled</code> for
     * SiteDefaults
     * or for any categories.</span>
     **/
