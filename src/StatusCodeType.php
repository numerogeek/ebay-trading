...
/**
 * This type is no longer used and was replaced by
 * ShippingLocationDetails
 * .
 **/
class StatusCodeType extends EbatNs_EnumType
{
    const TAG = 'StatusCodeType';
    const NAME = 'StatusCodeType';
