...
{
    const TAG = 'eBayMotorsProCompanyNameEnabledDefinitionType';
    const NAME = 'EBayMotorsProCompanyNameEnabledDefinitionType';
...
EBayMotorsProCompanyNameEnabledDefinitionType::_register();
