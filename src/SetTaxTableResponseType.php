 ...
 **/
class SetTaxTableResponseType extends EbatNs_Response
{
    const TAG = 'SetTaxTableResponseType';
    const NAME = 'SetTaxTableResponseType';
...
SetTaxTableResponseType::_register();
