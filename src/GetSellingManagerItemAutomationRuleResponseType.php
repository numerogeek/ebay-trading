 ...
 **/
class GetSellingManagerItemAutomationRuleResponseType extends EbatNs_Response
{
    const TAG = 'GetSellingManagerItemAutomationRuleResponseType';
    const NAME = 'GetSellingManagerItemAutomationRuleResponseType';
...
GetSellingManagerItemAutomationRuleResponseType::_register();
