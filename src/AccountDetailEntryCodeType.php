...
class AccountDetailEntryCodeType extends EbatNs_EnumType
{
     ...
     * If a listed item does not sell or results in an Unpaid Item case/dispute, the seller can relist the item with no
     * additional charge.
     **/
     ...
     * fee credit. If a listed item does not sell or results in an Unpaid Item case/dispute, the seller can relist
     * the item with no additional charge.
     **/
     ...
     * the fee again being charged to the seller. The Final Value Fee can be credited as a result of an Unpaid Item
     * Dispute, but if the buyer ultimately pays for the line item, the Final Value Fee will apply once again.
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is an insertion
     * fee credit for a fixed-price listing. If a listed item does not sell or results in an Unpaid Item
    ...
    /**
     * This enumeration value indicates that the account entry is a fee for the seller using a Listing Designer theme
     * and layout template for a listing.
     * 
     * 
     * <span class="tablenote">
     * Note:
     * As of May 31, 2020, sellers are no longer able to use Listing Designer templates when they create or revise
     * listings, so this fee will soon become inapplicable.</span>
     **/
    const CodeType_ListingDesignerFee = 'ListingDesignerFee';

    /**
     * This enumeration value indicates that the account entry is a credit issued by eBay to refund the seller using a
     * Listing Designer theme and layout template for a listing.
     * 
     * 
     * <span class="tablenote">
     * Note:
     * As of May 31, 2020, sellers are no longer able to use Listing Designer templates when they create or revise
     * listings, so this credit will soon become inapplicable.</span>
     **/
    ...
    /**
     * This enumeration value is only for internal use, and indicates that the login attempt to PayPal using OTP
     * ('One-Time Pin' or two-factor authentication) was successful.
     **/
    const CodeType_PayPalOTPSucc = 'PayPalOTPSucc';

    /**
     * This enumeration value is only for internal use, and indicates that the login attempt to PayPal using OTP
     * ('One-Time Pin' or two-factor authentication) is pending.
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is a fee for the seller using a Listing Designer theme
     * and layout template through the Selling Manager Pro UI, or through a Selling Manager Pro API call.
     * 
     * 
     * <span class="tablenote">
     * Note:
    ...
    /**
     * This enumeration value indicates that the account entry is a credit issued by eBay to the seller for a fee that
     * was charged to the seller for using a Listing Designer theme and layout template through the Selling Manager Pro
     * UI, or through a Selling Manager Pro API call.
     * 
     * 
     * <span class="tablenote">
     * Note:
    ...
    /**
     * This enumeration value acts as a note to indicate that the user's PayPal account information is linked with their
     * eBay account.
     **/
    const CodeType_PaypalOnFile = 'PaypalOnFile';

    /**
     * This enumeration value acts as a note to indicate that the user's PayPal account information was linked with
     * their eBay account by an eBay customer support represenative.
     **/
    const CodeType_PaypalOnFileByCSR = 'PaypalOnFileByCSR';

    /**
     * This enumeration value acts as a note to indicate that the user's PayPal account information is not linked with
     * their eBay account.
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is a fee charged to the seller's account if eBay is
     * forced to refund the buyer in a case where the buyer has used the eBay US Managed Returns process and return
     * shipped the item to the seller, but the seller has not issued a refund to the buyer within seven business days
     ...
     * case where the buyer has used the eBay US Managed Returns process and return shipped the item to the seller, but
     * the seller has not issued a refund to the buyer within seven business days after receiving the returned item. The
     * buyer credit amounts to the total purchase price plus any shipping costs if the item was "not as described".
     * eBay then charges this expense to the seller's account, and this charge is attached to the "FeeReturnRefund"
     * value.
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is a fee charged for an Ad on eBay. This Ad fee is
     * charged only for sellers who sign up to create Promoted Listings campaigns. When sellers advertise their
     * listings, the listings are displayed on the search results pages based on buyer search query. When a buyer clicks
     * on an ad and then goes on to purchase that same item within 30 days of click, the seller is charged an Ad fee.
     * The Ad fee that is charged is at the rate set by seller themselves. They choose the bid percentage for each item
     * listing.
     **/
    ...
    /**
     * This enumeration value indicates the charge is an eBay payment intermediation fee. This fee is only applicable
     * for sellers in the eBay managed payments program, currently only available to a select number of sellers on the
     * US and Germany sites.
     **/
    ...
    /**
     * This enumeration value indicates the invoice charge is an eBay payment intermediation fee. This fee is only
     * applicable for sellers in the eBay managed payments program, currently only available to a select number of
     * sellers on the US and Germany sites.
     **/
     ...
     * but the seller won the dispute.
     **/
    ...
    /**
     * This enumeration value indicates that PayPal has pulled out the 'Collect and Remit' sales tax amount that was
     * originally deposited to the seller's account. This enumeration value is only applicable to US sellers not opted
     * in to eBay managed payments, and for orders that are subject to eBay 'Collect and Remit' sales tax. See the
     * corresponding
     * OrderId
     * value to determine which eBay order this sales tax pertains to.
     * 
     * <span class="tablenote">
     * Note:
     * For US sellers not enabled for eBay managed payments, PayPal will now deposit the entire order amount,
     * including the 'Collect and Remit' sales tax, into the seller's account, and once the order funds clear, this
     * sales tax will be pulled from the seller's account and submitted to the proper tax authority. This change went
     * into effect on October 24, 2019. Previous to this date, PayPal pulled out the 'Collect and Remit' sales tax
     * before distributing order funds to the seller.
     * </span>
     **/
    const CodeType_USInternetSalesTax = 'USInternetSalesTax';

    /**
     * This enumeration value indicates that PayPal has deposited the 'Collect and Remit' sales tax amount (for the
     * order identified by the corresponding
     * OrderId
     * field) to the seller's account. This enumeration value is only applicable to US sellers not enabled for eBay
     * managed payments, and for orders that are subject to eBay 'Collect and Remit' sales tax. This sales tax will
     * actually get pulled from the seller's account shortly after the order funds clear, and the seller should then see
     * a
     * USInternetSalesTax
     * account entry with a matching amount.
     * 
     * <span class="tablenote">
     * Note:
     * For US sellers not enabled for eBay managed payments, PayPal will now deposit the entire order amount,
    ...
    /**
     * This enumeration value indicates that PayPal has pulled out the 'Goods and Services' tax amount that was
     * originally deposited to the seller's account. This enumeration value is only applicable to New Zealand sellers
     * for orders that are subject to 'Goods and Services' tax. See the corresponding
     * OrderId
     * value to determine which eBay order this tax pertains to.
     * 
     * <span class="tablenote">
     * Note:
     * PayPal will now deposit the entire order amount, including the 'Goods and Services' tax, into the seller's
     * account, and once the order funds clear, this sales tax will be pulled from the seller's account and submitted to
     * the proper tax authority. This change just went into effect on October 24, 2019. Previous to this date, PayPal
     * pulled out the 'Goods and Services' tax before distributing order funds to the seller.
     * </span>
     **/
    const CodeType_NewZealandGST = 'NewZealandGST';

    /**
     * This enumeration value indicates that PayPal has deposited the 'Goods and Services' tax amount (for the order
     * identified by the corresponding
     * OrderId
     * field) to the seller's account. This enumeration value is only applicable to New Zealand sellers for orders that
     * are subject to 'Goods and Services' tax. This tax will actually get pulled from the seller's account shortly
     * after the order funds clear, and the seller should then see a
     * NewZealandGST
     * account entry with a matching amount.
     * 
     * <span class="tablenote">
    ...
    /**
     * This enumeration value indicates that PayPal has pulled out the 'Goods and Services' tax amount that was
     * originally deposited to the seller's account. This enumeration value is only applicable to Australian sellers for
     ...
     * identified by the corresponding
     * OrderId
     * field) to the seller's account. This enumeration value is only applicable to Australia sellers for orders that
     * are subject to 'Goods and Services' tax. This tax will actually get pulled from the seller's account shortly
     * after the order funds clear, and the seller should then see a
     * AustraliaGST
     * account entry with a matching amount.
     ...
     * 
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments.
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is a final value fee that has already been deducted from
     * the seller payout associated with the order. This fee is calculated as a percentage of the total amount of the
     * order, including the purchase price and any shipping and handling charges.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
     * fee will start getting deducted from seller payouts as early as mid-June 2020 for a limited number of managed
     * payments sellers, and for all managed payments sellers by July 20, 2020. For more information about how final
     * value fees will change for managed payments sellers in July, see the <a
    ...
    /**
     * This enumeration value indicates that the account entry is a credit for final value fee that has already been
     * deducted from the seller payout associated with the order. The seller may get this credit for different reasons,
     * including if the buyer cancels the order, or the buyer doesn't pay for the order and the sellers files and wins
     * an Unpaid Item case.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments.
     * Final value fees will start getting deducted from seller payouts as early as mid-June 2020 for a limited number
     * of managed payments sellers, and for all managed payments sellers by July 20, 2020. For more information about
     * how final value fees will change for managed payments sellers in July, see the <a
     * href="https://www.ebay.com/help/selling/fees-credits-invoices/selling-fees?id=4822#section2"
     * target="_blank">Selling fees for managed payments sellers</a> page.
     * </span>
     **/
    ...
    /**
     * This enumeration value indicates that the account entry is an international fee that has already been deducted
     * from the seller payout associated with an order that is being shipped to another country. This fee is calculated
     * as a percentage of the total amount of the sale.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
     * fee will start getting deducted from seller payouts as early as mid-June 2020 for a limited number of managed
     * payments sellers, and for all managed payments sellers by July 20, 2020. For more information about this new
     * international fee for managed payments sellers, see the <a
    ...
    /**
     * This enumeration value indicates that the account entry is a credit against an international fee that has already
     * been deducted from the seller payout. This fee is calculated as a percentage of the total amount of the sale. The
     * seller may get this credit for different reasons, including if the buyer cancels the order, or the buyer doesn't
     * pay for the order and the sellers files and wins an Unpaid Item case.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
    ...
    /**
     * This enumeration value indicates that the account entry is a payment processing fee that has already been
     * deducted from the seller payout associated with the order. This is a fixed fee that is charged for all orders.
     * This fixed fee may vary by country, but it is current $0.30 in the US.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
    ...
    /**
     * This enumeration value indicates that the account entry is a credit against a payment processing fee that has
     * already been deducted from the seller payout associated with the order. Except for perhaps a very unlikely and
     * unusual situation, the payment processing fee will not be refunded to the seller.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
     * fixed payment processing fee will start getting deducted from seller payouts as early as mid-June 2020 for a
     * limited number of managed payments sellers, and for all managed payments sellers by July 20, 2020. For more
     * information about how final value fees will change for managed payments sellers in July, see the <a
     * href="https://www.ebay.com/help/selling/fees-credits-invoices/selling-fees?id=4822#section2"
     * target="_blank">Selling fees for managed payments sellers</a> page.
     * </span>
     **/
     ...
     * seller that has already been deducted from the seller payout associated with the order. Typically, this fee will
     * be an additional 5 percent (on top of standard final value fee) of the total amount of the order, including the
     * purchase price and any shipping and handling charges. It is possible that this fee may also be charged to an
     * Above Standard or Top-rated seller if that seller is having an issue with 'item not as described' return
     * requests.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
     * fee will start getting deducted from seller payouts as early as mid-June 2020 for a limited number of managed
     * payments sellers, and for all managed payments sellers by July 20, 2020. For more information about this
     * additional final value fee for managed payments sellers, see the <a
     ...
     * Below Standard seller that has already been deducted from the seller payout associated with the order.
     * 
     * <span class="tablenote">
     * Note:
     * This enumeration value is only applicable for eBay sellers that are enabled for eBay managed payments. This
     * Below Standard final value fee will start getting deducted from seller payouts as early as mid-June 2020 for a
     * limited number of managed payments sellers, and for all managed payments sellers by July 20, 2020. For more
     * information about this additional final value fee for managed payments sellers, see the <a
     * href="https://www.ebay.com/help/selling/fees-credits-invoices/selling-fees?id=4822#section6"
     * target="_blank">Selling fees for managed payments sellers</a> page.
     * </span>
     **/
