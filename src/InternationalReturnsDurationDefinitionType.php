...
/**
 * The values returned in this field indicate the return-duration options that are available for international
 * returns for items listed in the associated marketplace and category.
...
{
    const TAG = 'InternationalReturnsDurationDefinitionType';
    const NAME = 'InternationalReturnsDurationDefinitionType';
...
InternationalReturnsDurationDefinitionType::_register();
