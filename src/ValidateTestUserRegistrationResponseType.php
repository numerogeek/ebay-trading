 ...
 **/
class ValidateTestUserRegistrationResponseType extends EbatNs_Response
{
    const TAG = 'ValidateTestUserRegistrationResponseType';
    const NAME = 'ValidateTestUserRegistrationResponseType';
...
ValidateTestUserRegistrationResponseType::_register();
