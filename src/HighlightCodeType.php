 ...
 * Note:
 * This enumerated type is deprecated as the Highlighted listing feature is no longer available on any eBay
 * Marketplace sites.
 * </span>
 **/
class HighlightCodeType extends EbatNs_EnumType
{
    const TAG = 'HighlightCodeType';
    const NAME = 'HighlightCodeType';
