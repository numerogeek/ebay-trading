 ...
 **/
class PromotionMethodCodeType extends EbatNs_EnumType
{
    const TAG = 'PromotionMethodCodeType';
    const NAME = 'PromotionMethodCodeType';
    ...
    {
        return $this->_value === self::CodeType_CrossSell;
    }
    ...
    {
        return $this->_value === self::CodeType_UpSell;
    }
...
PromotionMethodCodeType::_register();
