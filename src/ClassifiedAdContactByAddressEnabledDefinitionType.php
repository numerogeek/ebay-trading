...
{
    const TAG = 'ClassifiedAdContactByAddressEnabledDefinitionType';
    const NAME = 'ClassifiedAdContactByAddressEnabledDefinitionType';
...
ClassifiedAdContactByAddressEnabledDefinitionType::_register();
