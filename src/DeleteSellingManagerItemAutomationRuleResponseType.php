 ...
 **/
class DeleteSellingManagerItemAutomationRuleResponseType extends EbatNs_Response
{
    const TAG = 'DeleteSellingManagerItemAutomationRuleResponseType';
    const NAME = 'DeleteSellingManagerItemAutomationRuleResponseType';
...
DeleteSellingManagerItemAutomationRuleResponseType::_register();
