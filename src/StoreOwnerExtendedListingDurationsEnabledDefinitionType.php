...
{
    const TAG = 'StoreOwnerExtendedListingDurationsEnabledDefinitionType';
    const NAME = 'StoreOwnerExtendedListingDurationsEnabledDefinitionType';
...
StoreOwnerExtendedListingDurationsEnabledDefinitionType::_register();
