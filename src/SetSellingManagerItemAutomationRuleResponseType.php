 ...
 **/
class SetSellingManagerItemAutomationRuleResponseType extends EbatNs_Response
{
    const TAG = 'SetSellingManagerItemAutomationRuleResponseType';
    const NAME = 'SetSellingManagerItemAutomationRuleResponseType';
...
SetSellingManagerItemAutomationRuleResponseType::_register();
