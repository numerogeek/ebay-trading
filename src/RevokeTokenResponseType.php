 ...
 **/
class RevokeTokenResponseType extends EbatNs_Response
{
    const TAG = 'RevokeTokenResponseType';
    const NAME = 'RevokeTokenResponseType';
...
RevokeTokenResponseType::_register();
