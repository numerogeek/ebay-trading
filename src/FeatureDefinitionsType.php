 ...
 * GetCategoryFeatures
 * response to indicate which eBay features are available on one more eBay API-enabled sites. If no
 * FeatureID
 * field is included in the call request, all eBay features available for one more eBay API-enabled sites are
