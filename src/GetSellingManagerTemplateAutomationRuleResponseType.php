 ...
 **/
class GetSellingManagerTemplateAutomationRuleResponseType extends EbatNs_Response
{
    const TAG = 'GetSellingManagerTemplateAutomationRuleResponseType';
    const NAME = 'GetSellingManagerTemplateAutomationRuleResponseType';
...
GetSellingManagerTemplateAutomationRuleResponseType::_register();
