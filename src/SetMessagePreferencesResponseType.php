 ...
 **/
class SetMessagePreferencesResponseType extends EbatNs_Response
{
    const TAG = 'SetMessagePreferencesResponseType';
    const NAME = 'SetMessagePreferencesResponseType';
...
SetMessagePreferencesResponseType::_register();
