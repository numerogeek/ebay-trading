...
abstract class EbatNs_AbstractClient
{
    ...
    */
    ...
    public function __construct($session, $dataConverter = 'EbatNs_DataConverterUtf8')
    {
    ...
    public function curlRequestType($requestType, $apiMethod = null, $xmlns = 'urn:ebay:apis:eBLBaseComponents')
    {
        ...
        $parser = (new EbatNs_ResponseParser($dataConverter, $callbacks, $xmlns))->withDefaultTag($responseTag);
