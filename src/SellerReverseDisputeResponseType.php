 ...
 **/
class SellerReverseDisputeResponseType extends EbatNs_Response
{
    const TAG = 'SellerReverseDisputeResponseType';
    const NAME = 'SellerReverseDisputeResponseType';
...
SellerReverseDisputeResponseType::_register();
