...
{
    const TAG = 'StoreOwnerExtendedListingDurationsDefinitionType';
    const NAME = 'StoreOwnerExtendedListingDurationsDefinitionType';
...
StoreOwnerExtendedListingDurationsDefinitionType::_register();
