 ...
 **/
class VerifyAddFixedPriceItemResponseType extends EbatNs_Response
{
    const TAG = 'VerifyAddFixedPriceItemResponseType';
    const NAME = 'VerifyAddFixedPriceItemResponseType';
...
VerifyAddFixedPriceItemResponseType::_register();
