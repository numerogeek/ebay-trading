 ...
 * GetCategoryFeatures
 * response (as long as
 * <code>BestOfferEnabled</code> is included as a
 * FeatureID
 * value in
 ...
 * field.
 * 
 * To verify if a specific category on a specific eBay site supports the Best Offer feature, pass in a
 * CategoryID
...
{
    const TAG = 'BestOfferEnabledDefinitionType';
    const NAME = 'BestOfferEnabledDefinitionType';
...
BestOfferEnabledDefinitionType::_register();
