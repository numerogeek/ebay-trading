 ...
 * GetCategoryFeatures
 * response (as long as
 * <code>BestOfferAutoDeclineEnabled</code> or <code>BestOfferAutoAcceptEnabled</code> is included as a
 * FeatureID
 * value in
 ...
 * field.
 * 
 * To verify if a specific category on a specific eBay site supports the Best Offer Auto Decline feature, pass
 * in a
 * CategoryID
...
{
    const TAG = 'BestOfferAutoDeclineEnabledDefinitionType';
    const NAME = 'BestOfferAutoDeclineEnabledDefinitionType';
...
BestOfferAutoDeclineEnabledDefinitionType::_register();
