 ...
 **/
class AttributeConversionEnabledCodeType extends EbatNs_EnumType
{
    const TAG = 'AttributeConversionEnabledCodeType';
    const NAME = 'AttributeConversionEnabledCodeType';
...
AttributeConversionEnabledCodeType::_register();
