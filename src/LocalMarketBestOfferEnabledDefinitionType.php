...
{
    const TAG = 'LocalMarketBestOfferEnabledDefinitionType';
    const NAME = 'LocalMarketBestOfferEnabledDefinitionType';
...
LocalMarketBestOfferEnabledDefinitionType::_register();
