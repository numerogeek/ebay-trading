...
{
    const TAG = 'LocalMarketNonSubscriptionDefinitionType';
    const NAME = 'LocalMarketNonSubscriptionDefinitionType';
...
LocalMarketNonSubscriptionDefinitionType::_register();
