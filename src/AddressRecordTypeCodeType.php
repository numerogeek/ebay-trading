 ...
 **/
class AddressRecordTypeCodeType extends EbatNs_EnumType
{
    const TAG = 'AddressRecordTypeCodeType';
    const NAME = 'AddressRecordTypeCodeType';
    ...
    {
        return $this->_value === self::CodeType_Residential;
    }
...
AddressRecordTypeCodeType::_register();
