 ...
 * 
 * To verify if a specific eBay site supports Cross Border Trade listings on the eBay US and eBay Canada sites
 * (for most
 ...
 * field.
 * 
 * To verify if a specific category on a specific eBay site supports Cross Border Trade listings on the eBay US
 * and eBay Canada sites, pass in a
 * CategoryID
...
{
    const TAG = 'CrossBorderTradeNorthAmericaEnabledDefinitionType';
    const NAME = 'CrossBorderTradeNorthAmericaEnabledDefinitionType';
...
CrossBorderTradeNorthAmericaEnabledDefinitionType::_register();
