...
class ItemType extends EbatNs_ComplexType
{
    ...
    {
        return $this->_dc($this->HitCounter);
    }
     ...
     * @return void
     */
    public function setHitCounter($value)
    {
        $this->HitCounter = $this->_enum($value, HitCounterCodeType::class);
    }
    ...
    {
        return $this->_dc($this->IncludeRecommendations === 'true', 'IncludeRecommendations');
    }
     ...
     * @return void
     */
    public function setIncludeRecommendations($value)
    {
        $this->IncludeRecommendations = self::_bool($value);
    }
    ...
    public static function _register()
    {
        self::assignElements([
            ...
            'HitCounter' => ['type' => 'HitCounterCodeType', 'enum' => true, 'xmlns' => self::XMLNS],
            ...
            'IncludeRecommendations' => ['type' => 'bool'],
