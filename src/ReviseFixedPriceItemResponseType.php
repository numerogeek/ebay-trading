 ...
 * call. The response includes the Item ID for the revised item, the SKU value for the item (if any), listing
 * recommendations (if applicable), the estimated fees for the revised item (except the Final Value Fee, which isn't
 * calculated until the item has sold), the start and end times of the listing, and other details.
 **/
class ReviseFixedPriceItemResponseType extends EbatNs_Response
{
    const TAG = 'ReviseFixedPriceItemResponseType';
    const NAME = 'ReviseFixedPriceItemResponseType';
...
ReviseFixedPriceItemResponseType::_register();
