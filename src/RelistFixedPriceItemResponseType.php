 ...
 **/
class RelistFixedPriceItemResponseType extends EbatNs_Response
{
    const TAG = 'RelistFixedPriceItemResponseType';
    const NAME = 'RelistFixedPriceItemResponseType';
...
RelistFixedPriceItemResponseType::_register();
