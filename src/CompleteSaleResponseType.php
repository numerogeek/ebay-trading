 ...
 * Ack
 * value of <Success>true</code> in the response, as this value will indicate that the action(s) in the
 * CompleteSale
 * call were successful. If any other
 * Ack
 * value besides <Success>true</code> is returned, the seller should look for any returned error messages or
 * warnings.
 **/
