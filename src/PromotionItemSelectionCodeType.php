 ...
 **/
class PromotionItemSelectionCodeType extends EbatNs_EnumType
{
    const TAG = 'PromotionItemSelectionCodeType';
    const NAME = 'PromotionItemSelectionCodeType';
...
PromotionItemSelectionCodeType::_register();
