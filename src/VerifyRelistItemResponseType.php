 ...
 **/
class VerifyRelistItemResponseType extends EbatNs_Response
{
    const TAG = 'VerifyRelistItemResponseType';
    const NAME = 'VerifyRelistItemResponseType';
...
VerifyRelistItemResponseType::_register();
