 ...
 **/
class BidderStatusCodeType extends EbatNs_EnumType
{
    const TAG = 'BidderStatusCodeType';
    const NAME = 'BidderStatusCodeType';
    ...
    {
        return $this->_value === self::CodeType_Approved;
    }
    ...
    {
        return $this->_value === self::CodeType_Denied;
    }
...
BidderStatusCodeType::_register();
