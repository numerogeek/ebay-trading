 ...
 **/
class CheckoutMethodCodeType extends EbatNs_EnumType
{
    const TAG = 'CheckoutMethodCodeType';
    const NAME = 'CheckoutMethodCodeType';
     ...
     * @return bool
     */
    public function isThirdPartyCheckout()
    {
        return $this->_value === self::CodeType_ThirdPartyCheckout;
    }
...
CheckoutMethodCodeType::_register();
