 ...
 **/
class RefundingSourceTypeCodeType extends EbatNs_EnumType
{
    const TAG = 'RefundingSourceTypeCodeType';
    const NAME = 'RefundingSourceTypeCodeType';
     ...
     * @return bool
     */
    public function isScheduledPayout()
    {
        return $this->_value === self::CodeType_ScheduledPayout;
    }
    ...
    {
        return $this->_value === self::CodeType_BankAccount;
    }
...
RefundingSourceTypeCodeType::_register();
