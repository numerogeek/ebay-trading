 ...
 **/
class SendInvoiceResponseType extends EbatNs_Response
{
    const TAG = 'SendInvoiceResponseType';
    const NAME = 'SendInvoiceResponseType';
...
SendInvoiceResponseType::_register();
