...
{
    const TAG = 'PayPalRequiredForStoreOwnerDefinitionType';
    const NAME = 'PayPalRequiredForStoreOwnerDefinitionType';
...
PayPalRequiredForStoreOwnerDefinitionType::_register();
