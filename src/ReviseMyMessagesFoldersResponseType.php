 ...
 **/
class ReviseMyMessagesFoldersResponseType extends EbatNs_Response
{
    const TAG = 'ReviseMyMessagesFoldersResponseType';
    const NAME = 'ReviseMyMessagesFoldersResponseType';
...
ReviseMyMessagesFoldersResponseType::_register();
