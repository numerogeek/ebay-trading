 ...
 **/
class SetSellingManagerTemplateAutomationRuleResponseType extends EbatNs_Response
{
    const TAG = 'SetSellingManagerTemplateAutomationRuleResponseType';
    const NAME = 'SetSellingManagerTemplateAutomationRuleResponseType';
...
SetSellingManagerTemplateAutomationRuleResponseType::_register();
