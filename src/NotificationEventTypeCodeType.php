...
class NotificationEventTypeCodeType extends EbatNs_EnumType
{
     ...
     * relisted. This notification is also triggered when the Unpaid Item Assistant mechanism relists an item for the
     * seller.
     **/
    ...
    /**
     * This notification is sent to a subscribed seller each time a buyer responds to an Unpaid Item or Cancel
     * Transaction case that the subscribed seller has opened up against the buyer.
     **/
    const CodeType_BuyerResponseDispute = 'BuyerResponseDispute';

    /**
     * This notification is sent to a subscribed buyer if a seller opens up an Unpaid Item or Cancel Transaction case
     * against the subscribed buyer.
     * 
     * If subscribed to by a buyer and when applicable, this notification will appear through the
     * GetDispute
     * call response.
     **/
    ...
    /**
     * This notification is sent to a subscribed buyer each time a seller responds to an Item Not Received or (Item)
     * Significantly Not As Described case that the subscribed buyer has opened up against the seller.
     * 
     * If subscribed to by a buyer and when applicable, this notification will appear in the
     * GetDispute
     * call response.
    ...
    /**
     * This notification is sent to the subscribed buyer and seller if the seller closes an Unpaid Item or Cancel
     * Transaction case against the buyer.
     * 
    ...
    /**
     * This notification is sent to a subscribed seller when a buyer opens an Item Not Received dispute against that
     * seller.
     * 
     * If subscribed to by the seller and when applicable, this notification will appear in the
     * GetDispute
     * call response.
     **/
    ...
    /**
     * This notification is sent to a subscribed seller when a buyer responds to an Item Not Received dispute opened by
     * that buyer.
     * 
     * If subscribed to by the seller and when applicable, this notification will appear in the
     * GetDispute
    ...
    /**
     * This notification is sent to a subscribed seller when a buyer closes an Item Not Received dispute opened by that
     * buyer.
     * 
     * If subscribed to by the seller and when applicable, this notification will appear in the
     * GetDispute
    ...
    /**
     * This notification is sent to a subscribed buyer when a seller responds to an Item Not Received dispute opened by
     * the buyer.
     * 
     * If subscribed to by the buyer and when applicable, this notification will appear in the
     * GetDispute
     * call response.
     **/
