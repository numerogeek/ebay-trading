...
{
    const TAG = 'SiteDefaultsType';
    const NAME = 'SiteDefaultsType';
    ...
    {
        $this->LocalListingDistancesRegular = self::_string($value);
    }
    ...
    {
        $this->LocalListingDistancesSpecialty = self::_string($value);
    }
    ...
    {
        $this->LocalListingDistancesNonSubscription = self::_string($value);
    }
    ...
    {
        return $this->_dc($this->ISBNIdentifierEnabled === 'true', 'ISBNIdentifierEnabled');
    }
    ...
    {
        $this->ISBNIdentifierEnabled = self::_bool($value);
    }
    ...
    {
        return $this->_dc($this->UPCIdentifierEnabled === 'true', 'UPCIdentifierEnabled');
    }
    ...
    {
        $this->UPCIdentifierEnabled = self::_bool($value);
    }
    ...
    {
        return $this->_dc($this->EANIdentifierEnabled === 'true', 'EANIdentifierEnabled');
    }
    ...
    {
        $this->EANIdentifierEnabled = self::_bool($value);
    }
    ...
    {
        return $this->_dc($this->MaxFlatShippingCostCBTExempt === 'true', 'MaxFlatShippingCostCBTExempt');
    }
    ...
    {
        $this->MaxFlatShippingCostCBTExempt = self::_bool($value);
    }
    ...
    public static function _register()
    {
        self::assignElements([
            ...
            'ISBNIdentifierEnabled' => ['type' => 'bool'],
            'UPCIdentifierEnabled' => ['type' => 'bool'],
            'EANIdentifierEnabled' => ['type' => 'bool'],
            ...
            'MaxFlatShippingCostCBTExempt' => ['type' => 'bool'],
