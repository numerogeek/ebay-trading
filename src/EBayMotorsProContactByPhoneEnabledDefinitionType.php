...
{
    const TAG = 'eBayMotorsProContactByPhoneEnabledDefinitionType';
    const NAME = 'EBayMotorsProContactByPhoneEnabledDefinitionType';
...
EBayMotorsProContactByPhoneEnabledDefinitionType::_register();
