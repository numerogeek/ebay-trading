 ...
 * account) has rolled out to the US, Australia, Canada (English and French), and Italy sites. For other sites, only
 * one domestic and one international shipping rate table may be set up per seller. Until the seller's account is
 * updated with the new shipping rate tables in My eBay, the seller will continue to use the
 * DomesticRateTable
 * and
