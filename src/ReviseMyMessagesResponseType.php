 ...
 **/
class ReviseMyMessagesResponseType extends EbatNs_Response
{
    const TAG = 'ReviseMyMessagesResponseType';
    const NAME = 'ReviseMyMessagesResponseType';
...
ReviseMyMessagesResponseType::_register();
