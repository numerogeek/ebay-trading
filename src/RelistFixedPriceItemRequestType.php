...
/**
 * Enables a seller to relist a fixed-price listing that has recently ended on a specified eBay site. A seller has
 * to up to 90 days to relist an ended listing. When an item is relisted, it will receive a new
 * ItemID
...
{
    const TAG = 'RelistFixedPriceItemRequest';
    const NAME = 'RelistFixedPriceItemRequestType';
    const XMLNS = 'urn:ebay:apis:eBLBaseComponents';
    const REQUEST = 'RelistFixedPriceItem';
    ...
    /**
     * @return RelistFixedPriceItemResponseType|EbatNs_ResponseError
     * @param EbatNs_Client
     **/
...
RelistFixedPriceItemRequestType::_register();
