...
class AccountHistorySelectionCodeType extends EbatNs_EnumType
{
    ...
    /**
     * This value should be used if the eBay user wants to see the account entries for a specific invoice that was sent
     * to the user by eBay. If this value is used, the specific invoice is identified by including the
     * InvoiceDate
     * field and setting its value to the actual invoice date. If this value is used, the
     * BeginDate
     * , and
     * EndDate
     * fields of the
