...
{
    const TAG = 'ListingEnhancementDurationDefinitionType';
    const NAME = 'ListingEnhancementDurationDefinitionType';
...
ListingEnhancementDurationDefinitionType::_register();
