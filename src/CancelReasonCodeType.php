...
class CancelReasonCodeType extends EbatNs_EnumType
{
    ...
    /**
     * This value indicates that the seller initiated the cancellation of the order but at the request of the buyer, or
     * if the buyer supplied a bad/incorrect address at purchase time. This is a cancel reason that the seller can give
     * to avoid a seller defect for the cancellation.
     **/
