 ...
 **/
class SetUserPreferencesResponseType extends EbatNs_Response
{
    const TAG = 'SetUserPreferencesResponseType';
    const NAME = 'SetUserPreferencesResponseType';
...
SetUserPreferencesResponseType::_register();
