 ...
 **/
class SetShippingDiscountProfilesResponseType extends EbatNs_Response
{
    const TAG = 'SetShippingDiscountProfilesResponseType';
    const NAME = 'SetShippingDiscountProfilesResponseType';
...
SetShippingDiscountProfilesResponseType::_register();
