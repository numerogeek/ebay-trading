 ...
 **/
class ReviseCheckoutStatusResponseType extends EbatNs_Response
{
    const TAG = 'ReviseCheckoutStatusResponseType';
    const NAME = 'ReviseCheckoutStatusResponseType';
...
ReviseCheckoutStatusResponseType::_register();
